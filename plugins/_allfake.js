...
handler.all = async function (m) {
	...
	let pp = 'https://telegra.ph/file/69fd62b4c5e20e441175b.jpg'
	try {
...
//global.bg = await (await fetch(img)).buffer()
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'github.com/Manz404', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'mochammadimannudin87@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { showAdAttribution: true,// Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: `${pickRandom([`https://www.instagram.com/_dead.scream_`])}`,
				}
			}
		}
...
global.floc = {
	 ...
	 message: { "locationMessage": { "title":"Cirebon","h": `aloo`, 'jpegThumbnail': fs.readFileSync('./media/krizyn.jpg')}}
	}
...
//FAKEREPLY KONTAK
 global.fcon = {
	 ...
	 participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "status@broadcast" } : {}) },
	 message: { "contactMessage": { "title":"manz","h": `haloo`, 'jpegThumbnail': fs.readFileSync('./media/krizyn.jpg')}}
	}
